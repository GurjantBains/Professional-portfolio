...
export function Contact() {
    ...
    const email = "jantywebdev@gmail.com.com";
            ...
            <div className={"gap-20 flex flex-col justify-center w-full place-self-center"}>
                <div className={"contact-Home-Form-container flex justify-evenly place-items-center gap-3"}>
                    <motion.div  style={{...initial,...{transformOrigin:`left`,}}}
                        ...
                        <div className="text-4xl gap-5 flex flex-col " >
                            Linkedin
                            <motion.li className={"text-3xl cursor-pointer"} onClick={()=>handleRedirect("linkedin")} whileHover={{scale:0.95}} whileTap={{scale:1.1}}>GurjantBains
                            </motion.li>
                        </div>
                        <div className="text-4xl gap-5 flex flex-col " >
                            Github
                            <motion.li className={"text-3xl cursor-pointer"} onClick={()=>handleRedirect("github")} whileHover={{scale:0.95}} whileTap={{scale:1.1}}>Gurjant Singh
                            </motion.li>
                        </div>
                    </motion.div>
    ...
    return (
        <StyledWrapper1 className="" style={{
            ...
            <div className="button-container ">
                ...
                <button className="button flex-center overflow-hidden">
                    <img src={"svg/linkedin-svg.svg"} className={"btn-svg"}/>
                    {/*<svg fill="#fff" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" className="btn-svg" width="22px" viewBox="0 -2 20 20">*/}
                    {/*    <g strokeWidth={0} id="SVGRepo_bgCarrier" />*/}
                    {/*    <g strokeLinejoin="round" strokeLinecap="round" id="SVGRepo_tracerCarrier" />*/}
                    {/*    <g id="SVGRepo_iconCarrier">*/}
                    {/*        <title>Linkdedin [#154]</title>*/}
                    {/*        <desc>Created with Sketch.</desc>*/}
                    {/*        <defs />*/}
                    {/*        <g fillRule="evenodd" fill="none" strokeWidth={1} stroke="none" id="Page-1">*/}
                    {/*            <g fill="#fff" transform="translate(-60.000000, -7521.000000)" id="Dribbble-Light-Preview">*/}
                    {/*                <g transform="translate(56.000000, 160.000000)" id="icons">*/}
                    {/*                    <path id="twitter-[#154]" d="M10.29,7377 C17.837,7377 21.965,7370.84365 21.965,7365.50546 C21.965,7365.33021 21.965,7365.15595 21.953,7364.98267 C22.756,7364.41163 23.449,7363.70276 24,7362.8915 C23.252,7363.21837 22.457,7363.433 21.644,7363.52751 C22.5,7363.02244 23.141,7362.2289 23.448,7361.2926 C22.642,7361.76321 21.761,7362.095 20.842,7362.27321 C19.288,7360.64674 16.689,7360.56798 15.036,7362.09796 C13.971,7363.08447 13.518,7364.55538 13.849,7365.95835 C10.55,7365.79492 7.476,7364.261 5.392,7361.73762 C4.303,7363.58363 4.86,7365.94457 6.663,7367.12996 C6.01,7367.11125 5.371,7366.93797 4.8,7366.62489 L4.8,7366.67608 C4.801,7368.5989 6.178,7370.2549 8.092,7370.63591 C7.488,7370.79836 6.854,7370.82199 6.24,7370.70483 C6.777,7372.35099 8.318,7373.47829 10.073,7373.51078 C8.62,7374.63513 6.825,7375.24554 4.977,7375.24358 C4.651,7375.24259 4.325,7375.22388 4,7375.18549 C5.877,7376.37088 8.06,7377 10.29,7376.99705" />*/}
                    {/*                </g>*/}
                    {/*            </g>*/}
                    {/*        </g>*/}
                    {/*    </g>*/}
